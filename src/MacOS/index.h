...
/*------------------------------Defines------------------------------*/
#define INDEX_BOUND_CHECKING  /* Perform bound checking during index evaluation
...
//#define MATTRIX_VERSION  /* ifdef, Corteo_130715 instead of Corteo_090527: corteo.mat */
    ...
    #define MINS   0.00000001490116119384765625f  /* minimum reduced impact parameter = 2^(-26) */
